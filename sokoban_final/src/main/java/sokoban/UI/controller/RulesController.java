...
// contrôleur de l'écran des règles du jeu.
// Charge les images et gère le retour au menu.
public class RulesController {
    ...
    @FXML private ImageView RulesView, view1, view2, view3, view4,
                            wasdView, PionView, BoxView, TargetView;
    ...
    // charge toutes les images de l'écran des règles
    public void initialize() {
        ...
        BoxView.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/sokoban/UI/resources/assets/box.png"))));
